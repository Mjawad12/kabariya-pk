...
function Process() {
  return (
    <div className="w-full overflow-hidden">
      <div className="w-full h-5 bg-black edge"></div>
      <div className="z-20 flex flex-col items-center justify-center w-full gap-20 px-10 pb-12 mP min-h-max smaller:px-5 ">
        <div className="flex flex-col items-center justify-center gap-5">
          <h3 className="font-pm font-med text-3xl leading-[35px] smaller:text-2xl">
            Our Process
          </h3>
          <h3 className="font-pm font-bol text-6xl leading-[41.61px] large:text-5xl small:text-4xl ">
            How it's work
          </h3>
        ...
        <div className="flex flex-wrap items-center justify-center w-full gap-5 small:gap-7 ">
