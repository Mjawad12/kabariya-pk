    ...
    <div className="w-full flex flex-col gap-[6rem] small:gap-[2rem] overflow-hidden">
      <div className="max-w-[1600px] w-full mt-16 small:mt-9 smaller:mt-6 relative  px-5 smallest:px-3">
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          <div className="w-full flex justify-center items-center mob:flex-col relative">
            <button
          ...
          <p className="text-[3.5rem] font-pm font-bol small:text-[3.3rem] smo:text-[3rem] smaller:text-[2.5rem] mob:text-[2.1rem] smallest:text-[1.6rem] ">
            Kabariya User App
          </p>
        </div>
      ...
      <div className="max-w-[1600px] w-full mt-14 small:mt-9 smaller:mt-6 border-t border-[#00000033] py-[6.5rem] small:py-20 smaller:py-10 relative  px-5 ">
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          <div className="w-full flex justify-center mob:flex-col items-center relative">
          ...
          <p className="text-[3.5rem] font-pm font-bol text-primaryGreen small:text-[3.3rem] smo:text-[2.9rem] smaller:text-[2.5rem] mob:text-[1.8rem] smallest:text-[1.6rem]">
...
const DownloadCard = ({ src, app, border }) => {
  return (
    <div
      ...
      className="max-w-[445px] w-full smaller:max-w-[350px] mob:max-w-[320px] py-6 px-9 smallest:px-2 smaller:py-3 mob:px-5 bg-white rounded-[20px] min-h-[21rem] small:min-h-[18rem] mob:min-h-[15rem] smallest:min-h-[13rem] flex justify-between items-center "
    >
      <div>
        <Image
          src={src}
